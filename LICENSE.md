...
- All third party components incorporated into the deeper Software are licensed
...
include in any modified copies of the software a prominent notice stating
that you have modified the software.
...
license will be reinstated retroactively. However, if you violate these terms
after such reinstatement, any additional violation of these terms will cause
your license to terminate automatically and permanently.
...
The Sustainable Use License above allows internal business use and
non-commercial use, but it does not grant the right to offer the software as
a paid service, redistribute it commercially, or otherwise monetize it. If
you need rights beyond what the Sustainable Use License grants — for example,
to host deeper as a managed service or to embed it in a commercial product —
contact Junhyuk Lee for a separate commercial license.
